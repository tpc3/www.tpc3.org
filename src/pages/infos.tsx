...
const UsingTypescript: React.FC<PageProps<DataProps>> = ({ data, path }) => {
  ...
  return (
    <Layout>
      ...
      <Typography className={styles.text}>
        <a
          href="https://www.google.com/intl/ja_jp/forms/about"
      ...
      <Typography className={styles.text}>
        <a
          href="https://www.npmjs.com/package/react-fluid-animation"
          className={styles.linkNoColor}
        >
        ...
        <br />
        <a
          href="https://www.npmjs.com/package/react-awesome-slider"
          className={styles.linkNoColor}
        >
        ...
        <br />
        <a
          href="https://www.npmjs.com/package/react-parallax-tilt"
          className={styles.linkNoColor}
        >
          react-parallax-tilt
        </a>
